        ...
        <div class="images-details-wrapper">
            ...
            <div class="details-wrapper">
                <?php foreach ($bookById as $key => $value) { ?>
                    ...
                    <!-- nút bấm -->
                    <div class="button-wrapper frame">
                        <a href="javascript:void(0);" id="add-to-cart" class="btn add-to-cart custom-btn btn-7" data-book-id="<?php echo $value['book_id']; ?>"><span>Add to cart</span></a>
                        <a href="javascript:void(0);" id="buy-now-btn" class="btn add-to-cart custom-btn btn-7" data-book-id="<?php echo $value['book_id']; ?>"><span>Buy now</span></a>
                    </div>
