...
// Xuất biến $data ra console
// echo "<script>console.log(" . json_encode($user_cart) . ");</script>";
?>
      ...
      <main class="main-content">
        ...
        <section class="order-summary">
          <ul class="items-list">
            ...
            ?>
              <li>
                <img src="../public/img/<?php echo $value['image_path']; ?>" alt="Glow Cream" class="img-product">
                <div class="order-detail">
                  <div class="orderProduct-name"><?php echo $value['title'] ?></div>
                  <div class="quantity">
                    <input class="input_sl" id="input_sl-1" type="number" value="<?php echo $value['quantity']; ?>" min="1" readonly />
                  </div>
                </div>
                <p class="price"><?php echo number_format($value['total_price_per_item'], 0, '', '.') . 'đ'; ?></p>
              </li>
            <?php
            }
            ?>
          ...
          <div class="total-price">
            ...
            <p class="amount"><?php echo number_format($user_cart[0]['total_price'], 0, '', '.') . 'đ'; ?></p>
          </div>
        </section>
      </main>
    <?php endif; ?>
